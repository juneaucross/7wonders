      ...
      <table class="table">
        ...
        <tr class="table__player-row" v-for="(player, i) in playersArr">
          <td class="table__player table__player--name">
            <input type="text" :name="'playerName-' + (i+1)" v-model="player.name" value="">
          </td>
          <td class="table__player table__player--red">
            <input type="number" :name="'red-' + (i+1)" value="" v-model="player.red">
          </td>
          <td class="table__player table__player--gold">
            <input type="number" :name="'gold-' + (i+1)" value="" v-model="player.gold">
          </td>
          <td class="table__player table__player--wonder">
            <input type="number" :name="'wonder-' + (i+1)" value="" v-model="player.wonder">
          </td>
          <td class="table__player table__player--blue">
            <input type="number" :name="'blue-' + (i+1)" value="" v-model="player.blue">
          </td>
          <td class="table__player table__player--orange">
            <input type="number" :name="'orange-' + (i+1)" value="" v-model="player.orange">
          </td>
          <td class="table__player table__player--violet">
            <input type="number" :name="'violet-' + (i+1)" value="" v-model="player.violet">
          </td>
          <td class="table__player table__player--green">
            <input type="number" :name="'green-' + (i+1)" value="" v-model="player.green">
          </td>
          <td class="table__player table__player--leader">
            <input type="number" :name="'leader-' + (i+1)" value="" v-model="player.leader">
          </td>
        </tr>
      </table>
